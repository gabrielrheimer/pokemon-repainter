...
# ---------------------------------------------------------------------------
# Pokémon list in Pokédex order (display name, folder name)
# ---------------------------------------------------------------------------
...
POKEDEX_ORDER = [
    ...
    ("Crobat", "crobat"),
    ("Chinchou", "chinchou"), ("Lanturn", "lanturn"),
    ("Pichu", "pichu"),
    ("Cleffa", "cleffa"),
    ("Igglybuff", "igglybuff"),
    ...
    ("Aipom", "aipom"),
    ("Sunkern", "sunkern"), ("Sunflora", "sunflora"),
    ("Yanma", "yanma"),
    ...
    ("Wobbuffet", "wobbuffet"),
    ("Girafarig", "girafarig"),
    ("Pineco", "pineco"), ("Forretress", "forretress"),
    ("Dunsparce", "dunsparce"),
    ("Gligar", "gligar"),
    ("Steelix", "steelix"),
...
_available = set(os.listdir(POKEFIRERED))
POKEMON_LIST = [(d, f) for d, f in POKEDEX_ORDER if f in _available]

DISPLAY_NAMES = [d for d, _ in POKEMON_LIST]
FOLDER_NAMES = {d: f for d, f in POKEMON_LIST}
